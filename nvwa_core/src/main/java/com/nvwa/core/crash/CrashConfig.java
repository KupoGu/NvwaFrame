...
public class CrashConfig implements Serializable {
    ...
    private CusActivityOnCrash.EventListener eventListener = null;
    ...
    @Nullable
    public CusActivityOnCrash.EventListener getEventListener() {
        return eventListener;
    }

    public void setEventListener(@Nullable CusActivityOnCrash.EventListener eventListener) {
    ...
    public static class Builder {
        ...
        public static Builder create() {
            ...
            CrashConfig currentConfig = CusActivityOnCrash.getConfig();
         ...
         */
        @NonNull
        public Builder eventListener(@Nullable CusActivityOnCrash.EventListener eventListener) {
        ...
        public void apply() {
            CusActivityOnCrash.setConfig(config);
        }
    }
}

...
/**
 * @author G.god
 * Create by AS 2020/5/15 13:01
 */
public class CusActivityOnCrash {
    private final static String TAG = "CusActivityOnCrash";
    ...
    public static String getStackTraceFromIntent(@NonNull Intent intent) {
        return intent.getStringExtra(CusActivityOnCrash.EXTRA_STACK_TRACE);
    }
    ...
    public static CrashConfig getConfigFromIntent(@NonNull Intent intent) {
        return (CrashConfig) intent.getSerializableExtra(CusActivityOnCrash.EXTRA_CONFIG);
    }
    ...
    public static String getActivityLogFromIntent(@NonNull Intent intent) {
        return intent.getStringExtra(CusActivityOnCrash.EXTRA_ACTIVITY_LOG);
    }
    ...
    public static void setConfig(@NonNull CrashConfig config) {
        CusActivityOnCrash.config = config;
    }
